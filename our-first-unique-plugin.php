...
/*
    ...
    Description: Count words, characters and read time of post content.
    Version: 1.0
    Author: Arun
...
class WordCountAndTimePlugin {
    ...
    function checkboxHTML($option) { ?>
        <input type="checkbox" name="<?php echo $option['name']; ?>" value="1" <?php checked(get_option($option['name']), '1'); ?>>
